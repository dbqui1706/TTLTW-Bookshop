                ...
                <div class="product-info">
                    ...
                    <div class="product-details">
                        <h4 class="product-title">
                            <a href="/bookshop/product.html?id=${product.id}" target="_blank" class="a-poduct-title text-decoration-none">${product.title}</a>
                        </h4>
    ...
    attachOrderButtonEvents() {
        ...
        detailButtons.forEach(button => {
            button.addEventListener('click', () => {
                ...
                window.location.href = `/bookshop/order-detail.html?code=${orderId}`; // Chuyển đến trang chi tiết đơn hàng
            });
        });
        ...
        reviewButtons.forEach(button => {
            button.addEventListener('click', () => {
                ...
                window.location.href = `/bookshop/reviews.html?orderId=${orderId}`;
            });
        });
        ...
        try {
            ...
            if (response.success) {
                ...
                if (response.redirectToCart) {
                    setTimeout(() => {
                        window.location.href = '/bookshop/cart.html';
                    }, 1500);
                }
            } else {
                showToast(response.message, 'error');
