            ...
            <aside class="col-md-4 col-lg-3 mb-md-0 mb-3">
                <div class="card">
                    <form action="${pageContext.request.contextPath}/products" method="get">
                                    ...
                                    <c:forEach var="category" items="${requestScope.categories}" varStatus="status">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" value="${category}"
                                                   id="checkbox_category_${status.index}" name="categoryFilter"
                                                ${requestScope.categoryFilters.contains(category) ? 'checked' : ''}>
                                            <label class="form-check-label" for="checkbox_category_${status.index}">
                                                    ${category}
                                            </label>
                                        </div>
                                    </c:forEach>
                        ...
                        <article class="filter-group">
                            <header class="card-header my-1">
                                <a data-bs-toggle="collapse" href="#collapse_4" aria-expanded="true"
                    ...
                    <nav class="mt-4">
                        <ul class="pagination">
                            <li class="page-item ${requestScope.page == 1 ? 'disabled' : ''}">
                                <a class="page-link"
                                   href="${pageContext.request.contextPath}/products?page=${requestScope.page - 1}&${requestScope.filterQueryString}">
                                    Trang trước
                                </a>
                            </li>
                            ...
                            <c:forEach begin="1" end="${requestScope.totalPages}" var="i">
                                <c:choose>
                                    ...
                                    <c:otherwise>
                                        <li class="page-item">
                                            <a class="page-link"
                                               href="${pageContext.request.contextPath}/products?page=${i}&${requestScope.filterQueryString}">
                                                    ${i}
                                            </a>
                                        </li>
                                    </c:otherwise>
