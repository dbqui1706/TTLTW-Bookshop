    ...
    <div class="container">
        ...
        <div class="row py-3 align-items-center">
            ...
            <div class="col-md-3 col-12">
                <div class="user-menu">
                    <a href="/bookshop/index.html" title="Trang chủ" class="menu-item">
                        <i class="fas fa-home"></i>
                        <span>Trang chủ</span>
                    </a>
                    <div class="account-dropdown">
                        <a href="/bookshop/login.html" class="menu-item dropdown-toggle" id="accountMenu">
                            <i class="fas fa-user-circle"></i>
                            <span>Tài khoản</span>
                        </a>
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="/bookshop/account-info.html">Thông tin tài khoản</a>
                            <a class="dropdown-item" href="/bookshop/order-info.html">Đơn hàng của tôi</a>
                    ...
                    <div class="cart-container">
                        <a href="/bookshop/cart.html" class="cart-icon menu-item" title="Giỏ hàng">
...
<!-- JavaScript -->
<script src="<c:url value="/bookshop/js/app/login.js"/>" type="module"></script>
<script src="<c:url value="/bookshop/js/app/header.js"/>" type="module"></script>
</body>
