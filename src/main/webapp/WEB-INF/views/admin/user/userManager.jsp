                ...
                <nav class="mt-4">
                    <ul class="pagination">
                        <li class="page-item ${requestScope.page == 1 ? 'disabled' : ''}">
                            <a class="page-link"
                               href="<c:url value="/admin/userManager?page=${requestScope.page - 1}"/>">
                                Trang trước
                            </a>
                        </li>
                        ...
                        <c:forEach begin="1" end="${requestScope.totalPages}" var="i">
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <li class="page-item">
                                        <a class="page-link"
                                           href="<c:url value="/admin/userManager?page=${i}"/>">
                                                ${i}
                                        </a>
                                    </li>
                                </c:otherwise>
                        ...
                        <li class="page-item ${param.page == requestScope.totalPages ? 'disabled' : ''}">
                            <a class="page-link"
                               href="<c:url value="/admin/userManager?page=${param.page + 1}"/>">
                                Trang sau
                            </a>
                        </li>
                    </ul>
