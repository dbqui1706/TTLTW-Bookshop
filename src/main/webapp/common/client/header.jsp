                ...
                <div class="col-lg-5 col-xl-4">
                    <c:if test="${not empty sessionScope.currentUser}">
                        <ul class="nav col-12 col-lg-auto my-2 my-lg-0 justify-content-center justify-content-lg-end text-small">
                            ...
                            <li>
                                <a href="${pageContext.request.contextPath}/order" class="nav-link text-body position-relative">
                                <span id="order-danger"
                                      class="position-absolute top-0 end-0 mt-2 badge rounded-pill bg-danger invisible">
                                                    !!
                                </span>
                                    <i class="bi bi-list-check d-block text-center fs-3 position-relative"></i>
                                    Đơn hàng
                                </a>
                            </li>
                            <li>
